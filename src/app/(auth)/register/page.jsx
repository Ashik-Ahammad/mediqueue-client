      ...
      <div className="flex flex-col md:flex-row-reverse w-full max-w-4xl bg-white dark:bg-zinc-900 rounded-[2rem] shadow-sm border border-zinc-200 dark:border-zinc-800 overflow-hidden">
        ...
        <div className="w-full md:w-1/2 p-8 sm:p-12 flex flex-col justify-center">
          ...
          <form onSubmit={handleRegister} className="space-y-5">
            ...
            <div className="space-y-1.5">
              <Label htmlFor="photoUrl" className="text-zinc-700 dark:text-zinc-300">Photo URL</Label>
              <div className="relative">
          ...
          <p className="mt-8 text-center text-sm text-zinc-600 dark:text-zinc-400">
            ...
            <Link href="/login" className="font-semibold text-cyan-600 hover:text-cyan-700 dark:text-cyan-400 transition-colors">
              Login Now
            </Link>
          </p>
        </div>
